...
## Project Structure
    ...
    ├── testapiautoconnecto_59470  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_59470`
...
2. Clone this repo and `cd testapiautoconnecto_59470`
